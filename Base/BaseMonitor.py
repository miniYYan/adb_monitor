...
import os
import re
from  Base.AdbCommon import  AndroidDebugBridge
import time
...
def get_men(pkg_name, devices):
    try:
        ...
        print(s_men)
        men2 = re.findall("TOTAL:(\d+)*", s_men, re.S)
        print(men2)
    except:
        traceback.print_exc()
        men2 = 0
...
if __name__ == '__main__':
    ...
    # cpu_rate("2749")
    get_men('com.shopee.id.debug',"342d870")
    # pid = get_pid("com.shopee.id.debug", "DU2TAN15AJ049163")
    # print(pid)
    # get_flow(pid, "wifi", "DU2TAN1com.shopee.id.debugAJ049163")
    ...
    # get_flow(pid, "gprs", "342d870	device")
